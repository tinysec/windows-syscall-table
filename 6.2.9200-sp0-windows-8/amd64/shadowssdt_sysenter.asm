...
NtDCompositionCreateConnectionContext PROC STDCALL 
...
NtDCompositionDestroyConnectionContext PROC STDCALL 
...
NtDCompositionGetConnectionContextBatch PROC STDCALL 
...
NtDCompositionValidateAndReferenceSystemVisualForHwndTarget PROC STDCALL 
...
UMPDDrvQuerySpoolType PROC STDCALL
...
NtUserGetGlobalIMEStatus PROC STDCALL 
