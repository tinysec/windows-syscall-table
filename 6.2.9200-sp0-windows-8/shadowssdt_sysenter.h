...
// author: @TinySecEx
// shadowssdt sysenter stub for 6.2.9200-sp0-windows-8

#ifndef __6_2_9200_SP0_WINDOWS_8_SHADOWSSDT_SYSENTER_SUB_HEADER_FILE
	#define __6_2_9200_SP0_WINDOWS_8_SHADOWSSDT_SYSENTER_SUB_HEADER_FILE
...
#ifdef _WIN64
	PVOID __stdcall _DestroyPhysicalMonitor_CMonitorAPI__QEAAJPEAX_Z(
		PVOID	arg_01 ,
		PVOID	arg_02
	);
#endif// #ifdef _WIN64
...
#ifdef _WIN64
	PVOID __stdcall CCompositionBuffer__GetIndependentFlipState();
#endif// #ifdef _WIN64


#ifdef _WIN64
	PVOID __stdcall CDiscardInputQueue__GetType();
#endif// #ifdef _WIN64


#ifndef _WIN64
	PVOID __stdcall CFlipExBuffer__RemoveRealization(
		PVOID	arg_01 ,
		PVOID	arg_02
	);
#endif// #ifndef _WIN64
...
PVOID __stdcall NtDCompositionCreateConnectionContext(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtDCompositionDestroyConnectionContext(
	PVOID	arg_01
);
...
PVOID __stdcall NtDCompositionDwmSyncFlush();
...
PVOID __stdcall NtDCompositionGetConnectionContextBatch(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtDCompositionValidateAndReferenceSystemVisualForHwndTarget(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04
...
PVOID __stdcall NtTokenManagerOpenEvent(
	PVOID	arg_01
);
...
PVOID __stdcall NtUserGetGlobalIMEStatus(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtUserSetActiveProcess(
	PVOID	arg_01
);
...
#ifdef _WIN64
	PVOID __stdcall UMPDDrvQuerySpoolType();
#endif// #ifdef _WIN64
...
#endif //  __6_2_9200_SP0_WINDOWS_8_SHADOWSSDT_SYSENTER_SUB_HEADER_FILE
