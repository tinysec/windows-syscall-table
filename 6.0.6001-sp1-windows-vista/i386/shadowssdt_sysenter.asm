...
DxgStubReenableDirectDrawObject PROC STDCALL arg_01:DWORD , arg_02:DWORD
...
DxgStubReenableDirectDrawObject ENDP
...
DefaultHTCallBack PROC STDCALL arg_01:DWORD
