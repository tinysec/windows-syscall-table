...
#ifndef _WIN64
	PVOID __stdcall CIgnoreInputQueue__AddRef();
#endif// #ifndef _WIN64


#ifdef _WIN64
	PVOID __stdcall DirectComposition__CHostVisualMarshaler__RemoveAllChildren(
		PVOID	arg_01 ,
		PVOID	arg_02 ,
		PVOID	arg_03 ,
		PVOID	arg_04 ,
...
#ifndef _WIN64
	PVOID __stdcall HeapVidMemAllocAligned(
		PVOID	arg_01 ,
		PVOID	arg_02 ,
		PVOID	arg_03 ,
		PVOID	arg_04 ,
...
PVOID __stdcall NtTokenManagerOpenSection(
	PVOID	arg_01 ,
	PVOID	arg_02
);
