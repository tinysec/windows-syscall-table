...
// author: @TinySecEx
// shadowssdt sysenter stub for 6.1.7601-sp1-windows-7

#ifndef __6_1_7601_SP1_WINDOWS_7_SHADOWSSDT_SYSENTER_SUB_HEADER_FILE
	#define __6_1_7601_SP1_WINDOWS_7_SHADOWSSDT_SYSENTER_SUB_HEADER_FILE
...
#ifndef _WIN64
	PVOID __stdcall DestroyPhysicalMonitor(
		PVOID	arg_01
	);
#endif// #ifndef _WIN64
...
#ifdef _WIN64
	PVOID __stdcall DxEngVisRgnUniq();
#endif// #ifdef _WIN64


PVOID __stdcall DxgStubDvpReleaseNotification(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
#ifndef _WIN64
	PVOID __stdcall DxgStubDvpUpdateVideoPort(
		PVOID	arg_01 ,
		PVOID	arg_02 ,
		PVOID	arg_03 ,
		PVOID	arg_04
...
#ifndef _WIN64
	PVOID __stdcall DxgStubValidateTextureStageState(
		PVOID	arg_01
	);
#endif// #ifndef _WIN64
...
PVOID __stdcall NtGdiSfmGetNotificationTokens(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtUserCheckDesktopByThreadId(
	PVOID	arg_01
);
...
PVOID __stdcall NtUserDwmStartRedirection(
	PVOID	arg_01
);


PVOID __stdcall NtUserDwmStopRedirection();
...
PVOID __stdcall NtUserEndTouchOperation(
	PVOID	arg_01
);
...
PVOID __stdcall NtUserManageGestureHandlerWindow(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtUserSendTouchInput(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04
...
PVOID __stdcall NtUserSetProcessDPIAware();
...
PVOID __stdcall NtUserSfmDestroyLogicalSurfaceBinding(
	PVOID	arg_01
);


PVOID __stdcall NtUserSfmDxBindSwapChain(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtUserSfmDxGetSwapChainStats(
	PVOID	arg_01 ,
	PVOID	arg_02
);


PVOID __stdcall NtUserSfmDxOpenSwapChain(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04
...
PVOID __stdcall NtUserSfmDxQuerySwapChainBindingStatus(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtUserSfmDxReleaseSwapChain(
	PVOID	arg_01 ,
	PVOID	arg_02
);


PVOID __stdcall NtUserSfmDxReportPendingBindingsToDwm();


PVOID __stdcall NtUserSfmDxSetSwapChainBindingStatus(
	PVOID	arg_01 ,
	PVOID	arg_02
);


PVOID __stdcall NtUserSfmDxSetSwapChainStats(
	PVOID	arg_01 ,
	PVOID	arg_02
);


PVOID __stdcall NtUserSfmGetLogicalSurfaceBinding(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04
...
#endif //  __6_1_7601_SP1_WINDOWS_7_SHADOWSSDT_SYSENTER_SUB_HEADER_FILE
