...
NtAcquireCMFViewOwnership PROC STDCALL 
...
NtCancelDeviceWakeupRequest PROC STDCALL 
...
NtClearAllSavepointsTransaction PROC STDCALL 
...
NtClearSavepointTransaction PROC STDCALL 
...
NtGetPlugPlayEvent PROC STDCALL 
...
NtListTransactions PROC STDCALL 
...
NtMarshallTransaction PROC STDCALL 
...
NtPullTransaction PROC STDCALL 
...
NtRequestDeviceWakeup PROC STDCALL 
...
NtRequestWakeupLatency PROC STDCALL 
...
NtRollbackSavepointTransaction PROC STDCALL 
...
NtSavepointComplete PROC STDCALL 
...
NtSavepointTransaction PROC STDCALL 
