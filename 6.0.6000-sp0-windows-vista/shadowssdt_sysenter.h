...
// author: @TinySecEx
// shadowssdt sysenter stub for 6.0.6000-sp0-windows-vista

#ifndef __6_0_6000_SP0_WINDOWS_VISTA_SHADOWSSDT_SYSENTER_SUB_HEADER_FILE
	#define __6_0_6000_SP0_WINDOWS_VISTA_SHADOWSSDT_SYSENTER_SUB_HEADER_FILE
...
#ifndef _WIN64
	PVOID __stdcall DxgStubCanCreateD3DBuffer(
		PVOID	arg_01 ,
		PVOID	arg_02
	);
#endif// #ifndef _WIN64
...
#ifndef _WIN64
	PVOID __stdcall DxgStubGenericThunk(
		PVOID	arg_01 ,
		PVOID	arg_02 ,
		PVOID	arg_03 ,
		PVOID	arg_04 ,
...
#ifndef _WIN64
	PVOID __stdcall DxgStubGetDriverState(
		PVOID	arg_01
	);
#endif// #ifndef _WIN64
...
#ifdef _WIN64
	PVOID __stdcall DxgStubUnlockDirectDrawSurface(
		PVOID	arg_01 ,
		PVOID	arg_02 ,
		PVOID	arg_03 ,
		PVOID	arg_04 ,
...
PVOID __stdcall NtGdiDwmGetDirtyRgn(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtGdiDwmGetSurfaceData(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtUserDwmGetDxRgn(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtUserDwmHintDxUpdate(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
#ifndef _WIN64
	PVOID __stdcall SURFACE__bUnMap();
#endif// #ifndef _WIN64


#ifdef _WIN64
	PVOID __stdcall WatchdogDrvResetDevice();
#endif// #ifdef _WIN64
...
#endif //  __6_0_6000_SP0_WINDOWS_VISTA_SHADOWSSDT_SYSENTER_SUB_HEADER_FILE
