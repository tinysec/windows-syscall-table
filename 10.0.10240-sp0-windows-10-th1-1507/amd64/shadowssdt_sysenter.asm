...
NtDCompositionCapturePointer PROC STDCALL 
...
NtDCompositionGetAnimationTime PROC STDCALL 
...
NtDCompositionSetResourceCallbackId PROC STDCALL 
...
NtDCompositionSetVisualInputSink PROC STDCALL 
...
NtGdiDdDDINetDispStartMiracastDisplayDeviceEx PROC STDCALL 
...
NtUserGetDpiSystemMetrics PROC STDCALL 
