...
PVOID __stdcall NtCompositionSetDropTarget(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtDCompositionCommitSynchronizationObject(
	PVOID	arg_01
);
...
PVOID __stdcall NtDCompositionCreateSharedVisualHandle(
	PVOID	arg_01
);
...
PVOID __stdcall NtDCompositionProcessChannelBatchBuffer(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04
...
PVOID __stdcall NtDCompositionSetChildRootVisual(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtDWMBindCursorToOutputConfig(
	PVOID	arg_01
);


PVOID __stdcall NtDWMCommitInputSystemOutputConfig();


PVOID __stdcall NtDWMSetCursorOrientation(
	PVOID	arg_01
);


PVOID __stdcall NtDWMSetInputSystemOutputConfig(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtFlipObjectAddPoolBuffer(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtFlipObjectCreate(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtFlipObjectOpen(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04
...
PVOID __stdcall NtFlipObjectRemovePoolBuffer(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtGdiAddInitialFonts();
...
PVOID __stdcall NtGdiCreateOPMProtectedOutput(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtGdiDdDDIAddSurfaceToSwapChain(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDICheckMultiPlaneOverlaySupport3(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDICreateBundleObject(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDICreateHwContext(
	PVOID	arg_01
);


PVOID __stdcall NtGdiDdDDICreateHwQueue(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDICreateProtectedSession(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDIDDisplayEnum(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDIDestroyHwContext(
	PVOID	arg_01
);


PVOID __stdcall NtGdiDdDDIDestroyHwQueue(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDIDestroyProtectedSession(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDIDispMgrCreate(
	PVOID	arg_01
);


PVOID __stdcall NtGdiDdDDIDispMgrSourceOperation(
	PVOID	arg_01
);


PVOID __stdcall NtGdiDdDDIDispMgrTargetOperation(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDIExtractBundleObject(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDIFlushHeapTransitions(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDIGetAllocationPriority(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDIGetMemoryBudgetTarget(
	PVOID	arg_01
);


PVOID __stdcall NtGdiDdDDIGetMultiPlaneOverlayCaps(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDIGetPostCompositionCaps(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDIGetProcessDeviceLostSupport(
	PVOID	arg_01
);


PVOID __stdcall NtGdiDdDDIGetProcessSchedulingPriorityBand(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDIGetYieldPercentage(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDIOpenProtectedSessionFromNtHandle(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDIPresentMultiPlaneOverlay3(
	PVOID	arg_01
);


PVOID __stdcall NtGdiDdDDIPresentRedirected(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDIQueryFSEBlock(
	PVOID	arg_01
);


PVOID __stdcall NtGdiDdDDIQueryProcessOfferInfo(
	PVOID	arg_01
);


PVOID __stdcall NtGdiDdDDIQueryProtectedSessionInfoFromNtHandle(
	PVOID	arg_01
);


PVOID __stdcall NtGdiDdDDIQueryProtectedSessionStatus(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDIRemoveSurfaceFromSwapChain(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDISetDeviceLostSupport(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDISetFSEBlock(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDISetHwProtectionTeardownRecovery(
	PVOID	arg_01
);


PVOID __stdcall NtGdiDdDDISetMemoryBudgetTarget(
	PVOID	arg_01
);


PVOID __stdcall NtGdiDdDDISetMonitorColorSpaceTransform(
	PVOID	arg_01
);


PVOID __stdcall NtGdiDdDDISetProcessSchedulingPriorityBand(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDISetYieldPercentage(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDISubmitCommandToHwQueue(
	PVOID	arg_01
);


PVOID __stdcall NtGdiDdDDISubmitSignalSyncObjectsToHwQueue(
	PVOID	arg_01
);


PVOID __stdcall NtGdiDdDDISubmitWaitForSyncObjectsToHwQueue(
	PVOID	arg_01
);


PVOID __stdcall NtGdiDdDDITrimProcessCommitment(
	PVOID	arg_01
);


PVOID __stdcall NtGdiDdDDIUnOrderedPresentSwapChain(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiDdDDIUpdateAllocationProperty(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiEnsureDpiDepDefaultGuiFontForPlateau(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiGetAppliedDeviceGammaRamp(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtGdiGetBitmapDpiScaleValue(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiGetCertificateByHandle(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04
...
PVOID __stdcall NtGdiGetCertificateSizeByHandle(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtGdiGetDCDpiScaleValue(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiGetGammaRampCapability(
	PVOID	arg_01
);
...
PVOID __stdcall NtGdiGetProcessSessionFonts(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtGdiGetPublicFontTableChangeCookie();
...
PVOID __stdcall NtGdiScaleRgn(
	PVOID	arg_01 ,
	PVOID	arg_02
);


PVOID __stdcall NtGdiScaleValues(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtGdiSetPrivateDeviceGammaRamp(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtMITActivateInputProcessing(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtMITBindInputTypeToMonitors(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtMITCoreMsgKGetConnectionHandle(
	PVOID	arg_01 ,
	PVOID	arg_02
);


PVOID __stdcall NtMITCoreMsgKOpenConnectionTo(
	PVOID	arg_01 ,
	PVOID	arg_02
);


PVOID __stdcall NtMITCoreMsgKSend(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtMITDeactivateInputProcessing(
	PVOID	arg_01
);


PVOID __stdcall NtMITDisableMouseIntercept();


PVOID __stdcall NtMITEnableMouseIntercept(
	PVOID	arg_01
);


PVOID __stdcall NtMITGetCursorUpdateHandle();


PVOID __stdcall NtMITSetInputCallbacks(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04
...
PVOID __stdcall NtMITSynthesizeMouseInput(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtMITSynthesizeMouseWheel(
	PVOID	arg_01 ,
	PVOID	arg_02
);


PVOID __stdcall NtMITSynthesizeTouchInput(
	PVOID	arg_01
);


PVOID __stdcall NtMITUpdateInputGlobals(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtMITWaitForMultipleObjectsEx(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtQueryCompositionSurfaceHDRMetaData(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtRIMAreSiblingDevices(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtRIMDeviceIoControl(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtRIMEnableMonitorMappingForDevice(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtRIMFreeInputBuffer(
	PVOID	arg_01 ,
	PVOID	arg_02
);


PVOID __stdcall NtRIMGetDevicePreparsedData(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04
...
PVOID __stdcall NtRIMGetDeviceProperties(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtRIMGetDevicePropertiesLockfree(
	PVOID	arg_01 ,
	PVOID	arg_02
);


PVOID __stdcall NtRIMGetPhysicalDeviceRect(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtRIMGetSourceProcessId(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtRIMOnPnpNotification(
	PVOID	arg_01
);


PVOID __stdcall NtRIMOnTimerNotification(
	PVOID	arg_01 ,
	PVOID	arg_02
);


PVOID __stdcall NtRIMReadInput(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtRIMRegisterForInput(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtRIMSetTestModeStatus(
	PVOID	arg_01
);


PVOID __stdcall NtRIMUnregisterForInput(
	PVOID	arg_01
);
...
PVOID __stdcall NtSetCompositionSurfaceBufferUsage(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04
...
PVOID __stdcall NtSetCompositionSurfaceDirectFlipState(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtSetCompositionSurfaceHDRMetaData(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04
...
PVOID __stdcall NtUserAcquireInteractiveControlBackgroundAccess(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtUserBeginLayoutUpdate(
	PVOID	arg_01
);
...
PVOID __stdcall NtUserBroadcastThemeChangeEvent(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtUserCompositionInputSinkViewInstanceIdFromPoint(
	PVOID	arg_01 ,
	PVOID	arg_02
);


PVOID __stdcall NtUserConfirmResizeCommit(
	PVOID	arg_01
);
...
PVOID __stdcall NtUserCreateEmptyCursorObject(
	PVOID	arg_01
);
...
PVOID __stdcall NtUserEnableNonClientDpiScaling(
	PVOID	arg_01
);


PVOID __stdcall NtUserEnableResizeLayoutSynchronization(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtUserEnableWindowGDIScaledDpiMessage(
	PVOID	arg_01 ,
	PVOID	arg_02
);


PVOID __stdcall NtUserEnableWindowResizeOptimization(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtUserFunctionalizeDisplayConfig(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtUserGetActiveProcessesDpis();
...
PVOID __stdcall NtUserGetCursor();
...
PVOID __stdcall NtUserGetDpiForCurrentProcess();
...
PVOID __stdcall NtUserGetHDevName(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtUserGetInteractiveControlDeviceInfo(
	PVOID	arg_01 ,
	PVOID	arg_02
);


PVOID __stdcall NtUserGetInteractiveControlInfo(
	PVOID	arg_01 ,
	PVOID	arg_02
);


PVOID __stdcall NtUserGetInteractiveCtrlSupportedWaveforms(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtUserGetProcessDpiAwarenessContext(
	PVOID	arg_01
);
...
PVOID __stdcall NtUserGetQueueStatusReadonly(
	PVOID	arg_01
);
...
PVOID __stdcall NtUserGetResizeDCompositionSynchronizationObject(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtUserInheritWindowMonitor(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtUserInitializeGenericHidInjection(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtUserInitializePointerDeviceInjectionEx(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtUserInjectGenericHidInput(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtUserInteractiveControlQueryUsage(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtUserIsNonClientDpiScalingEnabled(
	PVOID	arg_01
);


PVOID __stdcall NtUserIsResizeLayoutSynchronizationEnabled(
	PVOID	arg_01
);
...
PVOID __stdcall NtUserIsWindowGDIScaledDpiMessageEnabled(
	PVOID	arg_01
);
...
PVOID __stdcall NtUserLockCursor(
	PVOID	arg_01
);
...
PVOID __stdcall NtUserMsgWaitForMultipleObjectsEx(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtUserProcessInkFeedbackCommand(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtUserReleaseDC(
	PVOID	arg_01
);
...
PVOID __stdcall NtUserRemoveInjectionDevice(
	PVOID	arg_01
);
...
PVOID __stdcall NtUserSendInteractiveControlHapticsReport(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtUserSetCursorPos(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtUserSetDesktopColorTransform(
	PVOID	arg_01
);


PVOID __stdcall NtUserSetDialogControlDpiChangeBehavior(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtUserSetInteractiveControlFocus(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtUserSetInteractiveCtrlRotationAngle(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtUserSetProcessDpiAwarenessContext(
	PVOID	arg_01 ,
	PVOID	arg_02
);


PVOID __stdcall NtUserSetProcessInteractionFlags(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtUserSetTargetForResourceBrokering(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtUserShowCursor(
	PVOID	arg_01
);
...
PVOID __stdcall NtUserStopAndEndInertia(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04
...
PVOID __stdcall NtUserSystemParametersInfoForDpi(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtUserUpdateWindowTrackingInfo(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtUserWOWCleanup(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtUserWindowFromDC(
	PVOID	arg_01
);
