...
// author: @TinySecEx
// ssdt sysenter stub for 10.0.16299-sp0-windows-10-rs3-1709

#ifndef __10_0_16299_SP0_WINDOWS_10_RS3_1709_SSDT_SYSENTER_SUB_HEADER_FILE
	#define __10_0_16299_SP0_WINDOWS_10_RS3_1709_SSDT_SYSENTER_SUB_HEADER_FILE
...
PVOID __stdcall NtAcquireProcessActivityReference(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtAdjustTokenClaimsAndDeviceGroups(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtAlertThreadByThreadId(
	PVOID	arg_01
);
...
PVOID __stdcall NtAllocateReserveObject(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtAlpcConnectPortEx(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtAlpcImpersonateClientContainerOfPort(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtAssociateWaitCompletionPacket(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtCancelTimer2(
	PVOID	arg_01 ,
	PVOID	arg_02
);


PVOID __stdcall NtCancelWaitCompletionPacket(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtCommitRegistryTransaction(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtCompareObjects(
	PVOID	arg_01 ,
	PVOID	arg_02
);


PVOID __stdcall NtCompareSigningLevels(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtConvertBetweenAuxiliaryCounterAndPerformanceCounter(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04
...
PVOID __stdcall NtCreateDirectoryObjectEx(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtCreateEnclave(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtCreateIRTimer(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtCreateLowBoxToken(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtCreatePartition(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04
...
PVOID __stdcall NtCreateProfileEx(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtCreateRegistryTransaction(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04
...
PVOID __stdcall NtCreateTimer2(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtCreateTokenEx(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtCreateWaitCompletionPacket(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtCreateWnfStateName(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtDeleteWnfStateData(
	PVOID	arg_01 ,
	PVOID	arg_02
);


PVOID __stdcall NtDeleteWnfStateName(
	PVOID	arg_01
);
...
PVOID __stdcall NtDisableLastKnownGood();
...
PVOID __stdcall NtEnableLastKnownGood();
...
PVOID __stdcall NtFilterBootOption(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtFilterTokenEx(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtFlushBuffersFileEx(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtGetCachedSigningLevel(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtGetCompleteWnfStateSubscription(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtGetCurrentProcessorNumberEx(
	PVOID	arg_01
);
...
PVOID __stdcall NtInitializeEnclave(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtLoadEnclaveData(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtLoadHotPatch(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtManagePartition(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtNotifyChangeDirectoryFileEx(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtNotifyChangeSession(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtOpenKeyTransactedEx(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtOpenPartition(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtOpenRegistryTransaction(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtQueryAuxiliaryCounterFrequency(
	PVOID	arg_01
);
...
PVOID __stdcall NtQueryDirectoryFileEx(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtQueryInformationByName(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtQuerySecurityAttributesToken(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtQuerySecurityPolicy(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtQuerySystemInformationEx(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtQueryWnfStateData(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtQueryWnfStateNameInformation(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtQueueApcThreadEx(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtRenameTransactionManager(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtReplacePartitionUnit(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtRevertContainerImpersonation();
...
PVOID __stdcall NtRollbackRegistryTransaction(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtSerializeBoot();
...
PVOID __stdcall NtSetCachedSigningLevel(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtSetCachedSigningLevel2(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtSetInformationSymbolicLink(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04
...
PVOID __stdcall NtSetInformationVirtualMemory(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtSetIoCompletionEx(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtSetWnfProcessNotificationEvent(
	PVOID	arg_01
);
...
PVOID __stdcall NtSubscribeWnfStateChange(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04
...
PVOID __stdcall NtTerminateEnclave(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
PVOID __stdcall NtUmsThreadYield(
	PVOID	arg_01
);
...
PVOID __stdcall NtUnmapViewOfSectionEx(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03
);
...
PVOID __stdcall NtUnsubscribeWnfStateChange(
	PVOID	arg_01
);


PVOID __stdcall NtUpdateWnfStateData(
	PVOID	arg_01 ,
	PVOID	arg_02 ,
	PVOID	arg_03 ,
	PVOID	arg_04 ,
...
PVOID __stdcall NtWaitForAlertByThreadId(
	PVOID	arg_01 ,
	PVOID	arg_02
);
...
#endif //  __10_0_16299_SP0_WINDOWS_10_RS3_1709_SSDT_SYSENTER_SUB_HEADER_FILE
